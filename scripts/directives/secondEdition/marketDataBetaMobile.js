 ...
 */
GLHApp.directive('marketDataBetaMobile', ['$location', "$window", 'ApiService', function ($location, $window, ApiService) {
    return {
        restrict: 'AE',
        replace: true,
        scope: {
        ...
        templateUrl: "templates/secondEdition/marketDataBetaMobile.html",
